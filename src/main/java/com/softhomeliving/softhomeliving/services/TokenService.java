package com.softhomeliving.softhomeliving.services;
	...
	public String generateToken(User user) {
		try {
			...
			String token = JWT.create()
					...
					.withSubject(user.getLogin()) 					// Usuario que faz a requisicao  do token
					.withExpiresAt(generateExpirationDate())		// Tempo para expirar
